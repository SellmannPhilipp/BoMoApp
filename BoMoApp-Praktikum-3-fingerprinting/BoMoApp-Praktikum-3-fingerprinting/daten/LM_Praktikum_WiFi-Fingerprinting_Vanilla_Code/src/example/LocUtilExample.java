...
public class LocUtilExample {
	...
	public static void main(String[] args) {
		...
		String offlinePath = "LM_Praktikum_WiFi-Fingerprinting_Vanilla_Code/MU.1.5meters.offline.trace", onlinePath = "LM_Praktikum_WiFi-Fingerprinting_Vanilla_Code/MU.1.5meters.online.trace";
		...
		try {
			...
			// 	System.out.println("" +entry.getGeoPosition().toString() + " - " + entry.getSignalStrengthSamples());
			// }
